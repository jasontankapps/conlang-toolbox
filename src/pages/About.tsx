...
const Home: FC = () => {
	...
	return (
		<IonPage className={theme}>
			...
			<ModalWrap {...modalPropsMaker(isOpenConcepts, setIsOpenConcepts)}><ConceptCard /></ModalWrap>
			<ModalWrap {...modalPropsMaker(isOpenLexicon, setIsOpenLexicon)}><LexCard /></ModalWrap>
